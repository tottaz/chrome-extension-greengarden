/**
 * Functionality to communicate with the Greengarden API. This should get loaded
...
Greengarden.ApiBridge = {
  ...
  baseApiUrl: function(opt_options) {
    ...
    return 'http://' + options.greengarden_host_port + '/api/' + this.API_VERSION;
  },

  /**
   * Make a request to the Greengarden API.
   *
